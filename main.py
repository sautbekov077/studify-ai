...
MODELS_CONFIG = {
    "notes": {
        ...
        "system": "Ты — эксперт по составлению конспектов.Отвечай на том языке на котором был запрос.ВАЖНО!: Если в запросе нет слова конспект или подобное то отвечай в простом формате с эмодзи. Структурируй информацию, выделяй главное. Используй Markdown."
    },
    "search": {
